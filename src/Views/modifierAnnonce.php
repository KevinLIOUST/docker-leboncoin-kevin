...
<body class="d-flex flex-column vh-100 bg-dark text-white">
    ...
    <main>
        ...
        <div class="d-flex justify-content-center align-items-center">
            <form class="w-75" action="index.php?url=modifierAnnonce/<?= $infosAnnonce["a_id"] ?>" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <div class="div-input p-2">
                        <input class="form-control" id="titre" type="text" name="titre" placeholder="Titre de l'annonce"
                            value="<?= $_SERVER['REQUEST_METHOD'] == 'POST' ? $_POST["titre"] : $infosAnnonce["a_title"] ?>">
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="text-center">
                        <div class="div-input p-2">
                            <textarea class="form-control" name="description" id="description" rows="10"
                                placeholder="description de l'annonce"><?= $_SERVER['REQUEST_METHOD'] == 'POST' ? $_POST["description"] : $infosAnnonce["a_description"] ?></textarea>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="div-input p-2">
                        <input class="form-control" id="prix" type="number" name="prix" placeholder="Prix de l'article"
                            value="<?= $_SERVER['REQUEST_METHOD'] == 'POST' ? $_POST["prix"] : $infosAnnonce["a_price"] ?>">
                    </div>
                </div>
                <div>
                ...
                <div class="d-flex justify-content-center mt-4 mb-4">
                    <input type="submit" class="btn btn-page" value="Modifier l'annonce">
                </div>
